...
namespace Jekyll
{
    ...
    /// </summary>
    public partial class RandomFM : Page
    {
        public RandomFM()
        {
            InitializeComponent();
        ...
        private void Close(object sender, RoutedEventArgs e)
        {
            ...
            time = int.Parse(TimeS.Text, new CultureInfo("en-US"));
        }
        ...
        private async void Button_Click_1(object sender, RoutedEventArgs e)
        {
            ...
            Error.Content = null;
            await Task.Delay(time * 1000).ConfigureAwait(true);
            try
            {
                string[] string_array = (from object item in List.Items select item.ToString()).ToArray();
                RdmGlobal.Text = "Выпадает: " + Environment.NewLine + string_array[new System.Random().Next(0, string_array.Length)];
            }
            catch (Exception ex)
            {
